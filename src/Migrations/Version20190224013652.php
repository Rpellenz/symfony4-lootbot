 ...
 */
final class Version20190224013652 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE loot_list ADD quality INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX idx_loot_guild_id_user_id_item_name_insert_ts ON loot_list');
        $this->addSql('ALTER TABLE loot_list DROP quality');
