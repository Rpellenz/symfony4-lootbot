 ...
 */
final class Version20190224113118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE items ADD quality INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX idx_items_item_name ON items');
        $this->addSql('ALTER TABLE items DROP quality');
