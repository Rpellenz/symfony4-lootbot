 ...
 */
final class Version20190301100547 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE guild (id INT AUTO_INCREMENT NOT NULL, guild_id VARCHAR(255) NOT NULL, guild_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
